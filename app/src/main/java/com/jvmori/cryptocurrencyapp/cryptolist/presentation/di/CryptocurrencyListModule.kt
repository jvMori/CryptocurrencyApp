...
import com.jvmori.cryptocurrencyapp.cryptolist.domain.usecases.GetCryptoCurrencyListUseCaseImpl
...
val cryptocurrencyListModule = module {
    ...
    single<GetCryptocurrencyListUseCase> { GetCryptoCurrencyListUseCaseImpl(get()) }
